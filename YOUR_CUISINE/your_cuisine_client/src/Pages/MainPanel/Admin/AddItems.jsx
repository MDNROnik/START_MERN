      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="w-full">
            <label className="block text-sm font-semibold mb-1 test-[#07252d]">
              Category*
            </label>
        ...
        <div className="space-y-6 flex flex-col justify-between">
          <div>
            ...
            <input
              ...
              {...register("image", { required: true })}
              accept="image/*"
              className="file-input w-full max-w-xs border bg-[#07252d] text-[#bcaf87] text-sm bg-[#07252d] text-[#bcaf87] placeholder-gray-400 file:bg-[#bcaf87] file:text-[#07252d] file:border-0 file:px-4 file:py-2 file:rounded-md"
            />
          </div>
